...
namespace BKM.Integration.Infrastructure.Features.FileIngestion.Persistence;

public sealed class IngestionRepository(AppDbContext db) : IIngestionRepository
{
